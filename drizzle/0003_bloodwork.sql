...
('rule-ferritin', 'ferritin', '["Ferritin","Serum Ferritin"]'::jsonb, 'ng/mL', 30, NULL, 'high', 'iron-ferrous-bisglycinate', 'Ferritin below 30 ng/mL suggests iron depletion. Iron bisglycinate is gentler than ferrous sulfate; confirm with full iron panel before dosing.', 'PMID: 25827593'),
('rule-mag-rbc', 'magnesium_rbc', '["Magnesium, RBC","Magnesium RBC","RBC Magnesium","Erythrocyte Magnesium"]'::jsonb, 'mg/dL', 5.0, NULL, 'medium', 'magnesium-glycinate', 'RBC magnesium below 5.0 mg/dL is low-normal at best. Magnesium glycinate 200-400 mg elemental at night is well tolerated.', 'PMID: 29084059'),
-- TODO: seed supplement tongkat-ali first; until then free-test rule has no target supplement
('rule-free-test', 'free_testosterone', '["Free Testosterone","Free T","Testosterone, Free"]'::jsonb, 'pg/mL', 50, NULL, 'medium', 'zinc-picolinate', 'Free testosterone below 50 pg/mL with symptoms warrants endocrinology workup. Zinc supports normal testosterone in deficient men.', 'PMID: 17984944'),
